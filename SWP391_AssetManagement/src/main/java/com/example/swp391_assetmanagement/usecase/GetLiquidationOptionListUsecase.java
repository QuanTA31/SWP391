...
public class GetLiquidationOptionListUsecase {
        ...
        public OptionDetailListDTOResponse execute(
                ...
                if ((ObjectUtils.isEmpty(assetRequestType)
                                || !Objects.equals(RequestType.of(assetRequestType).getValue(),
                ...
                boolean hasAnySelected = optionDetailService.countByRequestDetailId(requestDetailId, true) > 0;

                AssetRequest assetRequest = assetRequestService.findByUpdate(requestId);

                boolean isApproved = Objects.equals(
